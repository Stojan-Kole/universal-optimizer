class MutationInfo:
    def __init__(self):
        self.atomSwitchMap = {}
        with open('opt/single_objective/comb/drug_discovery_problem/mutations/atom_switch.txt', 'r') as atomSwitchFile:
        ...
        self.groupSwitchMap = {}
        with open('opt/single_objective/comb/drug_discovery_problem/mutations/group_switch.txt', 'r') as groupSwitchFile:
        ...
        self.insertions = []
        with open('opt/single_objective/comb/drug_discovery_problem/mutations/insertion.txt', 'r') as insertionFile:
